...
//here put a globe icon when clicked display the hole world
...
//console.log("id  "+mapPolygon.dataItem.id);
...
selectCountry(polygonSeries.getPolygonById($(this).data("areaid"),false));
}).hover(function() {
rollOverCountry(polygonSeries.getPolygonById($(this).data("areaid")));
});
$("<td>").appendTo(tr).data("areaid", area.id).html("<a href='../country/?cc="+area.id+"&country="+area.name+"' >"+area.name+"</a>");
